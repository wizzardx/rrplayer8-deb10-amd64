/// @file
/// A class to support samba mounts
...
public:
  ...
  windows_mount(const string & strwindows_path, const string & strlogin_user, const string & strencrypted_login_password, const string & strmnt_descr, const unsigned long long lngmin_free_space);
...
private:
  void clear(); ///< Reset object attributes
  /// do_mount - called by the constructor, because kdevelop can't catch breakpoints in constructors!
  void do_mount(const string & strwindows_path, const string & strlogin_user, const string & strencrypted_login_password, const string & strmnt_descr, const unsigned long long lngmin_free_space);
