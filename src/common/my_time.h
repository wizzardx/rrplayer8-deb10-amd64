...
/// Normalise a timeval record. Check if the tv_usec field is too high/low, and adjust the record.
...
/// A macro for fetching the gtmoffset portion of a datetime longint value.
/// This includes both timezone (7200 in SA) and any adjustments that were made
