...
public:
  ...
  // quick & easy checks:
  operator void*() { return (void*)run(); } // Let you use a loop like this while(fader) { usleep(200*1000); }
...
private:
  ...
  int intelapsed_ms; // How many milliseconds have elapsed since the slide began.
};
