...
#ifdef __linux__ // XMMS is only usable under linux!
 
#ifndef CONTROLSOCKET_H
#define CONTROLSOCKET_H
#define CONTROLSOCKET_H_VERSION 6 // Meaning 0.06
...
#endif // END: #ifndef CONTROLSOCKET_H
#endif // END: #ifdef __linux__ // XMMS is only usable under linux at this time! 
