...
public:
  ...
  void setup_as_music_profile(const string & strmusic_source, const string & strdesc);
...
private:
  ...
  void generate_music_playlist(programming_element_list & pel, const string & strsource);
